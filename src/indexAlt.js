...
class Pomodoro  extends React.Component {
                    ...
                    this.clearTimer = setInterval(() => {
                        ...
                        if(this.state.session===false){
                            ...
                            this.setState({
                                ...
                                seconds: this.state.seconds > 0 && this.state.seconds!==0 ? this.state.seconds-1 : 59,
                        ...
                        this.setState({
                            timeNum: Number(this.state.time),
                        });
    ...
    render(){
        ...
        const nums2 = <div key={1} className="nums" style={lastSesMin} id={"time-left"}>{Number(this.state.time)}</div>;
